    ...
    for (int i = 0; i < BULLET_NUM; i++) {
        if (m_firstBullets[i].m_Free) {
            if (m_power < 2) {
                ...
                m_firstBullets[i].m_SpeedY = PLAYER_REIMU_BULLET_SPEED;
                ...
                if (i + 1 < BULLET_NUM && m_firstBullets[i + 1].m_Free) {
                    ...
                    m_firstBullets[i + 1].m_SpeedY = PLAYER_REIMU_BULLET_SPEED;
                ...
                if (i + 2 < BULLET_NUM && m_firstBullets[i + 1].m_Free && m_firstBullets[i + 2].m_Free) {
                    ...
                    m_firstBullets[i + 2].m_SpeedY = PLAYER_REIMU_BULLET_SPEED;
